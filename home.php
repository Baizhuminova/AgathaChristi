...
<section class="home">
   ...
   <div class="content">
      <h3>Agatha Christie Library</h3>
      <p>Online ordering of books by the famous writer is <br> easy and affordable.</p>
      <a href="shop.php" class="white-btn">Show more</a>
   </div>
...
<section class="products">
   ...
   <div class="load-more" style="margin-top: 2.2rem; text-align:center">
